...
def main():
    ...
    parser.add_argument('--ben_gt_csv', type=str,
                        default="/Users/zilun/Desktop/nips_rebuttal/geometa/ben/BENs2_info.csv",
                        help='dir of ben gt')
    ...
    for df_row_train in tqdm(ben_train.iterrows()):
        ...
        geometa_cap_train, month_train = parse_ben_df(ben_img_info, geometa_template_ben[0])
    ...
    geometa_df_train.to_csv("ben_geometa_train.csv", index=False)
    ...
    for df_row_val in tqdm(ben_val.iterrows()):
        ...
        geometa_cap_val, month_val = parse_ben_df(ben_img_info, geometa_template_ben[0])
    ...
    geometa_df_val.to_csv("ben_geometa_val.csv", index=False)
